...
**MOI** (/lu'make/) is a nextflow pipeline that aims to cover extensive and diverse omics analyses. It offers 
end-to-end analysis of RNAseq, taking into account different RNA molecules, like isoforms of genes and miRNA. 
