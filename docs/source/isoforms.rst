...
Specify the path to a specific config file (this is a core Nextflow
command). See the `nf-core website
documentation <https://nf-co.re/usage/configuration>`__ for more
information.
